...
import { IconMiniMax, IconAdp, IconZai, IconAlibaba } from "~/component/icon"
...
const models = [
  ...
  { name: "Adp-V2-Pro", provider: "Xiaomi Adp" },
  { name: "Adp-V2-Omni", provider: "Xiaomi Adp" },
...
function LimitsGraph(props: { href: string }) {
  ...
  const graph = [
    ...
    { id: "adp-v2-pro", name: "Adp-V2-Pro", req: 1290, d: "150ms" },
