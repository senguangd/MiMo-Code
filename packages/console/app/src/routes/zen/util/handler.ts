...
import { and, Database, eq, isNull, lt, or, sql } from "@adp-ai/console-core/drizzle/index.js"
import { KeyTable } from "@adp-ai/console-core/schema/key.sql.js"
import { BillingTable, LiteTable, SubscriptionTable, UsageTable } from "@adp-ai/console-core/schema/billing.sql.js"
import { centsToMicroCents } from "@adp-ai/console-core/util/price.js"
import { getMonthlyBounds, getWeekBounds } from "@adp-ai/console-core/util/date.js"
import { Identifier } from "@adp-ai/console-core/identifier.js"
import { Billing } from "@adp-ai/console-core/billing.js"
import { Actor } from "@adp-ai/console-core/actor.js"
import { WorkspaceTable } from "@adp-ai/console-core/schema/workspace.sql.js"
import { ZenData } from "@adp-ai/console-core/model.js"
import { Subscription } from "@adp-ai/console-core/subscription.js"
import { BlackData } from "@adp-ai/console-core/black.js"
import { UserTable } from "@adp-ai/console-core/schema/user.sql.js"
import { ModelTable } from "@adp-ai/console-core/schema/model.sql.js"
import { ProviderTable } from "@adp-ai/console-core/schema/provider.sql.js"
...
import { LiteData } from "@adp-ai/console-core/lite.js"
import { Resource } from "@adp-ai/console-resource"
...
export async function handler(
  ...
  try {
    ...
    logger.metric({
      ...
      request: requestId,
      client: ocClient,
      ...(model === "adp-v2-pro-free" && JSON.stringify(body).length < 1000 ? { payload: JSON.stringify(body) } : {}),
    })
