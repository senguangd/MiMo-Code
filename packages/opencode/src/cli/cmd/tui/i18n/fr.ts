...
export const dict = {
  ...
  "tui.home.agreement.prefix": "En utilisant AdpCli, vous acceptez nos ",
  ...
  "tui.tips.config_files":
    "Créez {highlight}adpcli.json{/highlight} pour la configuration serveur et {highlight}tui.json{/highlight} pour le TUI",
  "tui.tips.global_config":
    "Placez les paramètres TUI dans {highlight}~/.config/adpcli/tui.json{/highlight} comme configuration globale",
  ...
  "tui.tips.mcp_oauth":
    "AdpCli gère automatiquement OAuth pour les serveurs MCP distants nécessitant une authentification",
  "tui.tips.custom_command":
    "Ajoutez des fichiers {highlight}.md{/highlight} dans {highlight}.adpcli/command/{/highlight} pour définir des invites personnalisées réutilisables",
  ...
  "tui.tips.custom_agent":
    "Ajoutez des fichiers {highlight}.md{/highlight} dans {highlight}.adpcli/agent/{/highlight} pour des personas IA spécialisés",
  ...
  "tui.tips.formatter": "AdpCli formate automatiquement les fichiers avec prettier, gofmt, ruff, etc.",
  ...
  "tui.tips.lsp": "AdpCli utilise des serveurs LSP pour une analyse de code intelligente",
  "tui.tips.custom_tool":
    "Créez des fichiers {highlight}.ts{/highlight} dans {highlight}.adpcli/tools/{/highlight} pour définir de nouveaux outils LLM",
  "tui.tips.tool_scripts": "Les définitions d'outils peuvent invoquer des scripts en Python, Go, etc.",
  "tui.tips.plugins":
    "Ajoutez des fichiers {highlight}.ts{/highlight} dans {highlight}.adpcli/plugin/{/highlight} pour des hooks d'événements",
  ...
  "tui.tips.plugin_protect":
    "Créez un plugin pour empêcher AdpCli de lire des fichiers sensibles",
  "tui.tips.run": "Utilisez {highlight}adp run{/highlight} pour des scripts non interactifs",
  "tui.tips.continue": "Utilisez {highlight}adp --continue{/highlight} pour reprendre la dernière session",
  "tui.tips.attach_cli":
    "Utilisez {highlight}adp run -f file.ts{/highlight} pour joindre des fichiers via la CLI",
  "tui.tips.format_json":
    "Utilisez {highlight}--format json{/highlight} pour une sortie lisible par machine dans les scripts",
  "tui.tips.serve": "Exécutez {highlight}adp serve{/highlight} pour exposer l'API AdpCli en mode headless",
  "tui.tips.attach_server":
    "Utilisez {highlight}adp run --attach{/highlight} pour vous connecter à un serveur en cours",
  "tui.tips.upgrade": "Exécutez {highlight}adp upgrade{/highlight} pour passer à la dernière version",
  "tui.tips.auth_list":
    "Exécutez {highlight}adp auth list{/highlight} pour voir tous les fournisseurs configurés",
  "tui.tips.agent_create":
    "Exécutez {highlight}adp agent create{/highlight} pour créer un agent en mode guidé",
  "tui.tips.github_install":
    "Exécutez {highlight}adp github install{/highlight} pour configurer le workflow GitHub",
  "tui.tips.github_oc":
  ...
  "tui.tips.theme_files":
    "Créez des fichiers de thème JSON dans le dossier {highlight}.adpcli/themes/{/highlight}",
  ...
  "tui.tips.debug_config":
    "Exécutez {highlight}adp debug config{/highlight} pour diagnostiquer la configuration",
  "tui.tips.print_logs":
  ...
  "tui.tips.zen":
    "Utilisez {highlight}/connect{/highlight} avec Adp Cli pour des modèles testés et sélectionnés",
  "tui.tips.agents_md":
  ...
  "tui.skill.adpcli.description": "Documentation intégrée des fonctionnalités, config et commandes AdpCli",
  ...
  "tui.skill.drive-adp.description": "Piloter un autre processus AdpCli — événements JSON headless ou TUI interactive via tmux",
  ...
  "tui.model.adp_auto.name": "Adp Auto (Adp-V2.5, gratuit pour une durée limitée)",
  ...
  "tui.dialog.try_best.handoff.description": "Demander à Adp de déléguer le travail restant à ce harnais",
  ...
  "tui.toast.update_available.success": "Mis à jour vers AdpCli v{{version}}. Veuillez redémarrer l'application.",
  ...
  "tui.voice.error.no_auth": "Utilisez /connect pour vous connecter à Adp, ou configurez voice.asr_model pour un autre fournisseur",
  ...
  // Adp Auto (free) — TUI login dialog
  "tui.dialog.login.adp_free": "Adp Auto (free)",
  "tui.dialog.login.adp_free.desc": "Canal anonyme gratuit — aucune connexion requise",
  "tui.dialog.login.adp_free.success": "Adp Auto (free) est prêt — modèle par défaut défini sur adp/adp-auto",
  "tui.dialog.login.adp_free.unavailable": "Fournisseur Adp Auto (free) non chargé",
  "tui.dialog.login.flow.title": "Connexion Adp",
  ...
  "cli.providers.adp.recommended_hint": "recommandé",
  "cli.providers.adp_free.hint": "Canal anonyme gratuit / adp-auto",
  "cli.providers.adp_free.verifying": "Vérification du canal Adp Auto (free)...",
  "cli.providers.adp_free.ready": "Canal Adp Auto (free) prêt",
  "cli.providers.adp_free.failed": "Échec de la vérification de Adp Auto (free)",
  "cli.providers.adp_free.default_set": "Modèle par défaut défini sur adp/adp-auto (contexte 1M, gratuit)",
  "cli.providers.adp_free.usage_hint":
    "Aucune connexion requise — exécutez simplement adp. Pour les modèles payants/premium, choisissez plutôt la connexion navigateur Adp.",
  "cli.providers.adp_login.decrypt_retry": "Échec du déchiffrement, veuillez réessayer ({remaining} tentatives restantes)",
  "cli.providers.adp_login.decrypt_exhausted": "Échec du déchiffrement, nombre maximal de tentatives atteint",
  ...
  "trust.capabilities": "Adp Cli pourra lire, modifier et exécuter des fichiers ici.",
