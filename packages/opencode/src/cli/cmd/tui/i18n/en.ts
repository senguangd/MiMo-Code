export const dict: Record<string, string> = {
  ...
  "tui.prompt.context.recalculating": "Context compacted; waiting for next model response",
  ...
  "tui.home.agreement.prefix": "By using AdpCli, you agree to our ",
  ...
  "tui.tips.config_files":
    "Create {highlight}adpcli.json{/highlight} for server settings and {highlight}tui.json{/highlight} for TUI settings",
  "tui.tips.global_config": "Place TUI settings in {highlight}~/.config/adpcli/tui.json{/highlight} for global config",
  ...
  "tui.tips.mcp_oauth": "AdpCli auto-handles OAuth for remote MCP servers requiring auth",
  "tui.tips.custom_command":
    "Add {highlight}.md{/highlight} files to {highlight}.adpcli/command/{/highlight} to define reusable custom prompts",
  ...
  "tui.tips.custom_agent":
    "Add {highlight}.md{/highlight} files to {highlight}.adpcli/agent/{/highlight} for specialized AI personas",
  ...
  "tui.tips.formatter": "AdpCli auto-formats files using prettier, gofmt, ruff, and more",
  ...
  "tui.tips.lsp": "AdpCli uses LSP servers for intelligent code analysis",
  "tui.tips.custom_tool":
    "Create {highlight}.ts{/highlight} files in {highlight}.adpcli/tools/{/highlight} to define new LLM tools",
  "tui.tips.tool_scripts": "Tool definitions can invoke scripts written in Python, Go, etc",
  "tui.tips.plugins":
    "Add {highlight}.ts{/highlight} files to {highlight}.adpcli/plugin/{/highlight} for event hooks",
  "tui.tips.plugin_notify": "Use plugins to send OS notifications when sessions complete",
  "tui.tips.plugin_protect": "Create a plugin to prevent AdpCli from reading sensitive files",
  "tui.tips.run": "Use {highlight}adp run{/highlight} for non-interactive scripting",
  "tui.tips.continue": "Use {highlight}adp --continue{/highlight} to resume the last session",
  "tui.tips.attach_cli": "Use {highlight}adp run -f file.ts{/highlight} to attach files via CLI",
  "tui.tips.format_json": "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "tui.tips.serve": "Run {highlight}adp serve{/highlight} for headless API access to AdpCli",
  "tui.tips.attach_server": "Use {highlight}adp run --attach{/highlight} to connect to a running server",
  "tui.tips.upgrade": "Run {highlight}adp upgrade{/highlight} to update to the latest version",
  "tui.tips.auth_list": "Run {highlight}adp auth list{/highlight} to see all configured providers",
  "tui.tips.agent_create": "Run {highlight}adp agent create{/highlight} for guided agent creation",
  "tui.tips.github_install": "Run {highlight}adp github install{/highlight} to set up the GitHub workflow",
  ...
  "tui.tips.theme_files": "Create JSON theme files in {highlight}.adpcli/themes/{/highlight} directory",
  ...
  "tui.tips.debug_config": "Run {highlight}adp debug config{/highlight} to troubleshoot configuration",
  ...
  "tui.tips.zen": "Use {highlight}/connect{/highlight} with Adp Cli for curated, tested models",
  ...
  "tui.skill.adpcli.description": "Self-documentation for AdpCli features, config, and commands",
  ...
  "tui.skill.drive-adp.description": "Programmatically drive another AdpCli process — headless JSON events or interactive TUI via tmux",
  ...
  "tui.model.adp_auto.name": "Adp Auto (Adp-V2.5, limited-time free)",
  ...
  "tui.dialog.try_best.handoff.description": "Ask Adp to delegate the unfinished work to this harness",
  ...
  "tui.toast.update_available.success": "Successfully updated to AdpCli v{{version}}. Please restart the application.",
  ...
  "tui.voice.error.no_auth": "Use /connect to sign in to Adp, or configure voice.asr_model for another provider",
  ...
  "tui.dialog.login.adp_free.desc": "Anonymous free channel — no login required",
  "tui.dialog.login.adp_free.success": "Adp Auto (free) is ready — default model set to adp/adp-auto",
  "tui.dialog.login.adp_free.unavailable": "Adp Auto (free) provider not loaded",
  "cli.providers.select": "Select provider",
  "cli.providers.other": "Other provider",
  "cli.providers.adp.recommended_hint": "recommended",
  "cli.providers.adp_free.hint": "Anonymous free channel / adp-auto",
  "cli.providers.adp_free.verifying": "Verifying Adp Auto (free) channel...",
  "cli.providers.adp_free.ready": "Adp Auto (free) channel ready",
  "cli.providers.adp_free.failed": "Adp Auto (free) verification failed",
  "cli.providers.adp_free.default_set": "Default model set to adp/adp-auto (1M context, free)",
  "cli.providers.adp_free.usage_hint": "No login required — just run adp. For paid/premium models, choose Adp browser login instead.",
  "cli.providers.adp_login.decrypt_retry": "Decryption failed, please retry ({remaining} attempts left)",
  "cli.providers.adp_login.decrypt_exhausted": "Decryption failed, max retries reached",
  ...
  "tui.dialog.login.flow.title": "Adp Login",
  ...
  "trust.capabilities": "Adp Cli will be able to read, edit, and execute files here.",
  ...
  "skip_permissions.body":
    "You started with --dangerously-skip-permissions. Adp Cli will read, edit, and execute files and run shell commands WITHOUT asking for approval. Only rules you have explicitly denied in config are still enforced. You are solely responsible for anything it does.",
