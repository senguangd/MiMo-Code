...
const KeybindsSchema = Schema.Struct({
  ...
  prompt_autocomplete_prev: keybind("up,ctrl+p", "Move to previous autocomplete item"),
  prompt_autocomplete_next: keybind("down,ctrl+n", "Move to next autocomplete item"),
  prompt_autocomplete_hide: keybind("escape", "Hide autocomplete"),
  prompt_autocomplete_select: keybind("return", "Select autocomplete item"),
  prompt_autocomplete_complete: keybind("tab", "Complete autocomplete item"),
  ...
  input_newline: keybind("shift+return,ctrl+return,alt+return,ctrl+j,kpenter", "Insert newline in input"),
