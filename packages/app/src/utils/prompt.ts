import type { AgentPart as MessageAgentPart, FilePart, Part, TextPart } from "@adp-ai/sdk/v2"
import type { AgentPart, FileAttachmentPart, ImageAttachmentPart, Prompt } from "@/context/prompt"
import { relativePathWithinRoot } from "@/context/file/path"
...
export function extractPromptFromParts(parts: Part[], opts?: { directory?: string; attachmentName?: string }): Prompt {
  ...
  const toRelative = (path: string) => {
    ...
    return relativePathWithinRoot(directory, path) ?? path
  }
