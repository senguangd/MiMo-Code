...
| `MIMOCODE_ENABLE_EXA`                 | boolean | 启用 Exa 网络搜索后端                   |
| `OPENCODE_ENABLE_EXA`                 | boolean | `MIMOCODE_ENABLE_EXA` 的兼容别名        |
...
| `MIMOCODE_EXPERIMENTAL_EXA`                     | boolean | 启用实验性 Exa 功能             |
| `OPENCODE_EXPERIMENTAL_EXA`                     | boolean | 兼容别名                        |
