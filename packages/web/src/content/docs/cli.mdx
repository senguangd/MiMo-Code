...
| `ADPCLI_ENABLE_EXA`                 | boolean | Enable the Exa web-search backend                 |
| `OPENCODE_ENABLE_EXA`                 | boolean | Compatibility alias for `ADPCLI_ENABLE_EXA`    |
...
| `ADPCLI_EXPERIMENTAL_EXA`                     | boolean | Enable experimental Exa features        |
