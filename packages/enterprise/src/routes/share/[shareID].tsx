import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@adp-ai/sdk/v2"
import { SessionTurn } from "@adp-ai/ui/session-turn"
import { SessionReview } from "@adp-ai/ui/session-review"
import { DataProvider } from "@adp-ai/ui/context"
import { FileComponentProvider } from "@adp-ai/ui/context/file"
import { WorkerPoolProvider } from "@adp-ai/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@adp-ai/ui/logo"
import { IconButton } from "@adp-ai/ui/icon-button"
import { ProviderIcon } from "@adp-ai/ui/provider-icon"
import { iife } from "@adp-ai/shared/util/iife"
...
import { Tabs } from "@adp-ai/ui/tabs"
import { MessageNav } from "@adp-ai/ui/message-nav"
import { FileSSR } from "@adp-ai/ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@adp-ai/ui/pierre/worker").then((m) => ({
