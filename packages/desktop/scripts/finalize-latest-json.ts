...
const releaseId = process.env.ADPCLI_RELEASE
if (!releaseId) throw new Error("ADPCLI_RELEASE is required")

const version = process.env.ADPCLI_VERSION
if (!version) throw new Error("ADPCLI_VERSION is required")
